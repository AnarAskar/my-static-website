  ...
  const features = [
    {
      ...
      description: "Create and dynamically refine custom step-by-step learning roadmaps tailored specifically to your speed and goals.",
    },
    {
      icon: Layers,
      title: "Milestones & Tasks",
      description: "Roadmaps are divided into milestones. Click any milestone to reveal structured, actionable nested checklists.",
    },
    {
      icon: Zap,
      title: "Daily Streak Engine",
      description: "Maintain consistency. Complete at least one task per day to advance your streak multiplier and grow your overall progress bar.",
    },
    {
      icon: Clock,
      title: "Integrated Pomodoro",
      description: "Boost your productivity. Utilize built-in Pomodoro timers directly inside your tasks to automatically reward your streak count.",
    },
    {
      icon: ShoppingBag,
      title: "Streak Freeze Store",
      description: "Protect your hard work. Spend accumulated reward points to buy Streak Freezes from the in-app economy shop.",
    },
  ];

  return (
    <section id="featured-app" className="py-24 sm:py-32 bg-zinc-900/30 relative border-y border-zinc-900/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20 space-y-4">
          ...
          <p className="text-zinc-400 text-sm sm:text-lg font-normal leading-relaxed">
            An AI-powered roadmap planner built with **React Native & Expo CLI** designed to gamify learning, keep you consistent, and map your educational journeys.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-center">
          ...
          <div className="col-span-1 lg:col-span-5 flex flex-col items-center">
            ...
            <p className="text-[11px] text-zinc-500 font-mono mt-4 text-center max-w-xs">
              ...
              <span className="text-zinc-400">public/videos/yourpath-demo.mp4</span>
            </p>
          ...
          <div className="col-span-1 lg:col-span-7 space-y-8">
            <div className="space-y-4">
              <span className="text-indigo-400 font-extrabold tracking-widest text-xs uppercase block">React Native • Expo CLI • AI Generator</span>
              <h3 className="text-2xl sm:text-4xl font-black text-white tracking-tight leading-tight">
                YourPath: Custom AI Roadmaps
              </h3>
              <p className="text-zinc-400 text-base sm:text-lg leading-relaxed font-normal">
                YourPath takes the confusion out of learning any new skill. Simply type a topic, and our integrated AI generates a structured, step-by-step roadmap. To ensure you stay committed, YourPath gamifies your routine using streak preservation systems, integrated focus mechanics, and a point-based economy store.
              </p>
            </div>

            {/* Tech Badges */}
            <div className="flex flex-wrap gap-2">
              {["React Native", "Expo Go", "AI Integration", "TypeScript", "NativeWind", "Streak System", "Pomodoro Timer", "AsyncStorage"].map((tech) => (
                <span 
                  key={tech}
            ...
            <div className="space-y-4 pt-6 border-t border-zinc-900/80">
              <h4 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Core Functionality</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {features.map((feat) => {
                  const Icon = feat.icon;
                  return (
                    <div key={feat.title} className="flex items-start space-x-3.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500 mt-1 leading-normal font-normal">{feat.description}</p>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-6 border-t border-zinc-900/80">
              ...
              <a
                href="https://youtube.com" // User can replace this with their actual YouTube link
                target="_blank"
