...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-24 sm:py-32 bg-zinc-900/40 border-t border-zinc-900 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <p className="text-zinc-400 text-sm sm:text-lg">
            Ready to build something amazing? Send me a message, or reach out
            directly at my active platforms.
          </p>
        </div>
            ...
            <div className="p-6 sm:p-8 bg-zinc-950/60 border border-zinc-900 rounded-2xl flex flex-col justify-between h-full space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Have a freelancing contract, permanent job opening, or
                  academic collaboration project? Drop an email or contact via
                  social networks.
                </p>
              </div>
